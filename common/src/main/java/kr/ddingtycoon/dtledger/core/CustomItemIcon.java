...
public final class CustomItemIcon {
    ...
    private static final Object[][] ENTRIES = {
            ...
            {"빠네", BEEF, 2004027f},
            {"꼬치", BEEF, 2004026f},
            // 형광 제련품(2026-09-09 패치) — 서버팩 실측 CustomModelData.
            //   원광(2058001~)·큐브(2058051~)·광물 캔디(2058201)는 전부 귀속이라 거래가 안 된다.
            //   내역에 뜰 일이 없으므로 넣지 않는다. 판매되는 건 제련품뿐(로니).
            {"오르딘 미니 망치", PAPER, 2058101f},
            {"루미트 강철 방패", PAPER, 2058105f},
            {"크레온 장인 석궁", PAPER, 2058102f},
            {"벨릭 사냥 스피어", PAPER, 2058103f},
            {"세르칸 초승달 단검", PAPER, 2058104f},
            // 영혼 명품(2026-09-23 가죽 공예) — 서버팩 실측. 이름은 게임 내 확인(2026-09-24).
            //   형용사+"가죽"으로 잡아 재료 "○○한 영혼 가죽"과 구분한다.
            {"고독한 가죽", PAPER, 2059105f},   // 키링
            {"신비한 가죽", PAPER, 2059102f},   // 팔찌
            {"활기찬 가죽", PAPER, 2059103f},   // 장갑
            {"특이한 가죽", PAPER, 2059106f},   // 파우치
            {"화끈한 가죽", PAPER, 2059104f},   // 핸드백

            // 플로리스트 향장품(카이 판매) — 꽃 이름 + 제품 꼴이라 5종만 넣으면 성급 무관하게 걸린다.
            // ⚠️ 반드시 아래 "오일"(요리 식재료)보다 먼저 와야 한다. match() 는 앞에서부터 첫 매칭을
            //    쓰므로, 뒤에 두면 "크리스텔라 오일"이 식용유 아이콘(2013005)으로 빠진다.
            //    CustomModelData 는 서버팩 실측(2026-08-19). 성급별로 번호가 다르지만 기본형으로 대표한다.
            {"아쿠아네타 앰플", PAPER, 2054005f},
            {"루밀리아 디퓨저", PAPER, 2054033f},
            {"솔라리스티 캔들", PAPER, 2054038f},
            {"벨라로제 퍼퓸", PAPER, 2054014f},
            {"크리스텔라 오일", PAPER, 2054023f},
